...
class HailoInfer:
    ...
    def __init__(
        ...
        """
        if not HAS_HAILO:
            raise RuntimeError("Hailo library (hailo_platform) not installed. Please install it to use Hailo hardware acceleration.")
        ...
        try:
            ...
            raise RuntimeError(f"Failed to create Hailo VDevice: {e}. Ensure Hailo hardware is connected.")
